...
<cfcomponent extends="DataMgr" displayname="Data Manager for DB2" hint="I manage data interactions with the DB2 database. I can be used to handle inserts/updates.">
